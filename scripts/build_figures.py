...
def figure1_share_exposure() -> None:
    ...
    ax.set_title("Figure 1: share versus exposure")
    ax.grid(True, color=GRID, linewidth=0.7)
    save_all(fig, "Figure_1_Share_Exposure_Scatter")
...
def figure2_cpwe_gli_coverage() -> None:
    ...
    save_all(fig, "Figure_2_CPWE_GLI_Coverage")
...
def figure3_top_country() -> None:
    ...
    axes[1].grid(True, color=GRID, linewidth=0.7)
    save_all(fig, "Figure_3_Top_Country_Contribution")
...
def figure4_controls() -> None:
    ...
    save_all(fig, "Figure_4_Controls")
